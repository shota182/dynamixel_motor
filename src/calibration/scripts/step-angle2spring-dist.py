...
if __name__ == "__main__":
    ...
    # param dynamics
    length_fixedend2springpulley_initial = 0.1              # l_1' (mm)
    length_springpulley2motor_initial = 0.05                # l_2' (mm)
    theta_wire_springpulley2motor_initial = 0.0             # theta_i' (deg)
    theta_wire_fixedend2springpulley_initial = 0.0          # theta_o' (deg)
    distance_fixedend2springpulley_holizontal = 0.1         # d_1 (mm)
    distance_springpulley2motor_holizontal = 0.05           # d_2 (mm)
    radius_springpulley = 0.01                              # r_s (mm)
    radius_fixedend = 0.01                                  # r_f (mm)
    radius_motor = 0.01                                     # r_m (mm)
    # param plot
    spring_displacement_limit = [0.0, 3.0]  # ばね変位のLimit (mm)
    plot_increment = 0.1  # プロットの間隔 (mm)

...
class StepAngle2SpringDist:
    def __init__(self, step_1lap, motor_id, length_fixedend2springpulley_initial, length_springpulley2motor_initial, theta_wire_fixedend2springpulley_initial, theta_wire_springpulley2motor_initial, distance_fixedend2springpulley_holizontal, distance_springpulley2motor_holizontal, radius_springpulley, radius_fixedend, radius_motor, spring_displacement_limit, plot_increment, spring_constant, save_csv_dir):
        # 初期化
        self.step_1lap = step_1lap                                                                                 # [step]
        self.motor_id = motor_id                                                                                   # モータID
        ...
        print(f"step_1lap: {self.step_1lap}")
        print(f"motor_id: {self.motor_id}")
        print(f"length_fixedend2springpulley_initial: {self.length_fixedend2springpulley_initial*1000} mm")
        print(f"length_springpulley2motor_initial: {self.length_springpulley2motor_initial*1000} mm")
        print(f"theta_wire_fixedend2springpulley_initial: {self.theta_wire_fixedend2springpulley_initial*180/np.pi} deg")
        print(f"theta_wire_springpulley2motor_initial: {self.theta_wire_springpulley2motor_initial*180/np.pi} deg")
        print(f"radius_springpulley: {self.radius_springpulley*1000} mm")
        print(f"radius_fixedend: {self.radius_fixedend*1000} mm")
        print(f"radius_motor: {self.radius_motor*1000} mm")
        print(f"spring_displacement_limit: {self.spring_displacement_limit*1000} mm")
        print(f"plot_increment: {self.plot_increment*1000} mm")
        print(f"spring_constant: {self.spring_constant} N/mm")
    ...
    def save_to_csv(self, a, b, c, name_a, name_b, name_c):
        if(len(a) != len(b) or len(a) != len(c)):
            ...
            sys.exit(1)
        filename = self.save_csv_dir + "/" + f"{self.motor_id}_stepangle_vs_springdist_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
    ...
    def caslc_tensionvertical2tension(self): # T
        ...
        if(self.bool_print): print(f"T: {self.tension} N")
    
    def calc_springdisplacement2tensionvertical(self): # T_n
        # ばね変位から張力のばね方向成分を計算する
        self.tension_vertical = self.spring_displacement * 10**(3) * self.spring_constant  # N (N/mm -> N)
        if(self.bool_print): print(f"T_v: {self.tension_vertical} N")
    ...
    def calc_lengthwirechange2stepmotorangle(self): # delta_x
        ...
        if(self.bool_print): print(f"delta_x: {self.step_motorangle}\n")
    
    def calc_lengthwirechange(self): # delta_l
        # ワイヤの長さ変化を計算する
        self.length_wire_change = self.length_wire_whole_initial - self.length_wire_whole
        if(self.bool_print): print(f"delta_l: {self.length_wire_change*1000}")
    ...
    def calc_lengthwholewireinitial(self): # L'
        ...
        if(self.bool_print): print(f"L': {self.length_wire_whole_initial*1000}")
    ...
    def calc_lengthwholewire(self): # L
        ...
        if(self.bool_print): print(f"L: {self.length_wire_whole*1000}")
    ...
    def calc_lengthwirespringpulley2motorinitial(self): # l_i'
        ...
        if(self.bool_print): print(f"l_i': {self.length_wire_springpulley2motor_initial*1000}")
    ...
    def calc_lengthwirefixedend2springpulleyinitial(self): # l_o'
        ...
        if(self.bool_print): print(f"l_o': {self.length_wire_fixedend2springpulley_initial*1000}")
    ...
    def calc_lengthwirespringpulleyinitial(self): # l_s'
        ...
        if(self.bool_print): print(f"l_s': {self.length_wire_springpulley_initial*1000}")
    ...
    def calc_lengthwirespringpulley2motor(self): # l_i
        ...
        if(self.bool_print): print(f"l_i: {self.length_wire_springpulley2motor*1000}")
    ...
    def calc_lengthwirefixedend2springpulley(self): # l_o
        ...
        if(self.bool_print): print(f"l_o: {self.length_wire_fixedend2springpulley*1000}")
    ...
    def calc_lengthwirespringpulley(self): # l_s
        ...
        if(self.bool_print): print(f"l_s: {self.length_wire_springpulley*1000}")
    ...
    def calc_thetawirespringpulley2motor(self): # theta_i
        ...
        if(self.bool_print): print(f"theta_i: {self.theta_wire_springpulley2motor*180/np.pi}")
    ...
    def calc_thetaspringpulley2motor(self): # theta_2
        ...
        if(self.bool_print): print(f"theta_2: {self.theta_springpulley2motor*180/np.pi}")
    ...
    def calc_lengthspringpulley2motor(self): # l_2
        ...
        if(self.bool_print): print(f"l_2: {self.length_springpulley2motor*1000}")
    ...
    def calc_heightspringpulley2motorinitial(self): # h_2
        ...
        if(self.bool_print): print(f"h_2: {self.height_springpulley2motor_initial*1000}")
    ...
    def calc_thetawirefixedend2springpulley(self): # theta_o
        ...
        if(self.bool_print): print(f"theta_o: {self.theta_wire_fixedend2springpulley*180/np.pi}")
    ...
    def calc_thetafixedend2springpulley(self): # theta_1
        ...
        if(self.bool_print): print(f"theta_1: {self.theta_fixedend2springpulley*180/np.pi}")
    ...
    def calc_lengthfixedend2springpulley(self): # l_1
        ...
        if(self.bool_print): print(f"l_1: {self.length_fixedend2springpulley*1000}")
    ...
    def calc_heightfixedend2springpulley(self): # h_1
        ...
        if(self.bool_print): print(f"h_1: {self.height_fixedend2springpulley*1000}")
...
if __name__ == "__main__":
    ...
    motor_id =  0
    # param dynamics
    length_fixedend2springpulley_initial = 65.5              # l_1' (mm)
    length_springpulley2motor_initial = 57                # l_2' (mm)
    theta_wire_springpulley2motor_initial = 5              # theta_i' (deg)
    theta_wire_fixedend2springpulley_initial = 6          # theta_o' (deg)
    ...
    radius_motor = 7.5                                     # r_m (mm)
    # param plot
    spring_displacement_limit = [0.0, 3.5]  # ばね変位のLimit (mm)
    plot_increment = 0.05  # プロットの間隔 (mm)
    # param spring
    spring_constant = 0.67  # k (N/mm)
    # param save

// masterはベースをmarginとして，slave反力を加算
// slaveは拮抗部分からの相対
// PID項をpublishする
...
private:
  ...
  void controlLoop(const ros::TimerEvent&) {
    ...
    // margin + 反力
    target_tension_master_1_ = tension_margin_ + std::max(0.0, tension_slave_3-tension_slave_2);
    target_tension_master_2_ = tension_margin_ + std::max(0.0, tension_slave_4-tension_slave_1);
    target_tension_master_3_ = tension_margin_ + std::max(0.0, tension_slave_1-tension_slave_4);
    target_tension_master_4_ = tension_margin_ + std::max(0.0, tension_slave_2-tension_slave_3);
